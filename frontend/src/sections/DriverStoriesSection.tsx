      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {milestones.map((milestone, idx) => (
            <div
              key={idx}
              className="bg-[#030914] border border-[#0E2644] hover:border-[#00A09A]/40 rounded-2xl p-6 flex flex-col items-center text-center gap-2 transition-all duration-300 hover:-translate-y-1"
            >
