      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <ScrollReveal className="text-center max-w-2xl mx-auto mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-extralight text-white tracking-tight">
            One Platform. <span className="font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-[#00A09A] to-[#00A09A]">Built for Charging Operators, Fleets &amp; Drivers.</span>
          </h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
          ...
          <ScrollReveal direction="left" as="div" id="cpos" className="lg:col-span-3 bg-[#030914] border-2 border-[#00A09A]/40 hover:border-[#00A09A]/70 rounded-3xl p-8 sm:p-10 transition-all duration-300 relative group flex flex-col justify-between shadow-[0_0_40px_rgba(0,160,154,0.1)]">
            <div>
              ...
              <p className="text-sm text-slate-300/90 leading-relaxed mb-5 font-normal">
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                {CMS_TAGS.map((tag) => (
                  <span key={tag} className="text-[10px] font-mono px-2.5 py-1 rounded-lg bg-[#0A2240]/70 border border-[#0E2C52] text-slate-300">
                    {tag}
                  </span>
                ))}
              </div>
          ...
          <ScrollReveal direction="right" delay={150} as="div" id="drivers" className="lg:col-span-2 bg-[#030914] border border-[#0E2644] hover:border-[#00A09A]/50 rounded-3xl p-8 sm:p-10 transition-all duration-300 relative group flex flex-col justify-between">
            <div>
