...
export const DigitalInfrastructureSection: React.FC = () => {
  ...
  return (
    <section id="infrastructure" className="py-24 bg-[#060B09] relative overflow-hidden border-t border-[#0F1E19]">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-[#00D09C]/5 rounded-full blur-[180px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="relative max-w-5xl mx-auto py-12">
          ...
          <div className="relative flex items-center justify-center min-h-[540px]">
            ...
            {/* Outer Ring 3 */}
            <div className="absolute w-[500px] h-[500px] sm:w-[560px] sm:h-[560px] rounded-full border border-[#00D09C]/15 pointer-events-none" />
            
            {/* Middle Ring 2 */}
            <div className="absolute w-[360px] h-[360px] sm:w-[420px] sm:h-[420px] rounded-full border border-[#00D09C]/20 pointer-events-none" />
            
            {/* Inner Ring 1 */}
            <div className="absolute w-[240px] h-[240px] sm:w-[280px] sm:h-[280px] rounded-full border border-[#00D09C]/30 pointer-events-none bg-[#07130F]/40" />

            {/* Radar Sweep Effect */}
            <div className="absolute w-[460px] h-[460px] rounded-full pointer-events-none animate-radar">
              <div className="w-1/2 h-1/2 bg-gradient-to-br from-[#00D09C]/20 to-transparent rounded-tl-full origin-bottom-right" />
            </div>

            {/* Crosshair Axes */}
            <div className="absolute w-full max-w-[620px] h-px bg-[#00D09C]/15 pointer-events-none" />
            <div className="absolute h-full max-h-[620px] w-px bg-[#00D09C]/15 pointer-events-none" />

            {/* Center Core: TREVIA Infrastructure */}
            <div className="relative z-20 w-36 h-36 rounded-full bg-[#050D0A] border-2 border-[#00D09C] shadow-[0_0_40px_rgba(0,208,156,0.3)] flex flex-col items-center justify-center p-4 text-center group cursor-pointer">
              <div className="w-10 h-10 rounded-xl bg-[#00D09C]/10 flex items-center justify-center text-[#00D09C] mb-1">
                <Layers className="w-6 h-6 animate-pulse" />
              </div>
              <span className="text-sm font-extrabold tracking-wider text-white trevia-brand-text">
                TREVIA
              </span>
              <span className="text-[11px] font-medium text-[#00D09C]">
                Infrastructure
              </span>
            </div>
            ...
            <div className="absolute inset-0 grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-14 pointer-events-auto">
              ...
              <div 
                ...
                className={`cursor-pointer transition-all duration-300 p-5 rounded-2xl flex flex-col justify-start md:pr-12 ${
                  activeQuadrant === 1 ? 'bg-[#0A1A14]/80 border border-[#00D09C]/40' : 'hover:bg-white/[0.02]'
                }`}
              >
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-9 h-9 rounded-full bg-[#0E2720] border border-[#00D09C]/40 flex items-center justify-center text-[#00D09C]">
                    <Share2 className="w-4 h-4" />
                  </div>
                  <span className="text-xs font-mono font-bold text-[#00D09C]">01</span>
                </div>
              ...
              <div 
                ...
                className={`cursor-pointer transition-all duration-300 p-5 rounded-2xl flex flex-col justify-start md:pl-12 text-left ${
                  activeQuadrant === 2 ? 'bg-[#0A1A14]/80 border border-[#00D09C]/40' : 'hover:bg-white/[0.02]'
                }`}
              >
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-9 h-9 rounded-full bg-[#0E2720] border border-[#00D09C]/40 flex items-center justify-center text-[#00D09C]">
                  ...
                  <span className="text-xs font-mono font-bold text-[#00D09C]">02</span>
                </div>
              ...
              <div 
                ...
                className={`cursor-pointer transition-all duration-300 p-5 rounded-2xl flex flex-col justify-end md:pr-12 ${
                  activeQuadrant === 3 ? 'bg-[#0A1A14]/80 border border-[#00D09C]/40' : 'hover:bg-white/[0.02]'
                }`}
              >
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-9 h-9 rounded-full bg-[#0E2720] border border-[#00D09C]/40 flex items-center justify-center text-[#00D09C]">
                  ...
                  <span className="text-xs font-mono font-bold text-[#00D09C]">03</span>
                </div>
              ...
              <div 
                ...
                className={`cursor-pointer transition-all duration-300 p-5 rounded-2xl flex flex-col justify-end md:pl-12 text-left ${
                  activeQuadrant === 4 ? 'bg-[#0A1A14]/80 border border-[#00D09C]/40' : 'hover:bg-white/[0.02]'
                }`}
              >
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-9 h-9 rounded-full bg-[#0E2720] border border-[#00D09C]/40 flex items-center justify-center text-[#00D09C]">
                  ...
                  <span className="text-xs font-mono font-bold text-[#00D09C]">04</span>
                </div>
          ...
          <div className="mt-14 flex flex-col items-center">
            ...
            <div className="w-px h-12 bg-gradient-to-b from-[#00D09C]/50 to-[#00D09C]/10" />

            {/* Horizontal branch line */}
            <div className="w-48 h-px bg-[#00D09C]/30" />
            ...
            <div className="grid grid-cols-2 gap-12 sm:gap-24 pt-6 text-center">
              ...
              <div className="flex flex-col items-center group cursor-pointer">
                <div className="w-12 h-12 rounded-2xl bg-[#091813] border border-[#143D30] text-[#00D09C] flex items-center justify-center mb-3 shadow-lg group-hover:border-[#00D09C] group-hover:scale-110 transition-all">
