    ...
    <div className="space-y-24 md:space-y-36 pb-24">
      ...
      <section className="max-w-7xl mx-auto px-6 space-y-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="p-8 rounded-3xl bg-[#030A14] border border-[#0E2C52] hover:border-[#00A8FF] transition-all space-y-4 flex flex-col justify-between group">
            <div className="space-y-3">
              <div className="w-10 h-10 rounded-xl bg-[#061426] border border-[#0E2C52] flex items-center justify-center text-[#00F0FF]">
                <BookOpen className="w-5 h-5" />
              </div>
              <span className="text-[10px] font-mono uppercase tracking-wider text-[#00F0FF] font-bold">Whitepaper</span>
            ...
            <div className="pt-4 border-t border-[#0E2C52] flex items-center justify-between text-xs font-mono text-[#00F0FF]">
          ...
          <div className="p-8 rounded-3xl bg-[#030A14] border border-[#0E2C52] hover:border-[#00A8FF] transition-all space-y-4 flex flex-col justify-between group">
            <div className="space-y-3">
              ...
              <span className="text-[10px] font-mono uppercase tracking-wider text-[#00A8FF] font-bold">Guide</span>
              <h4 className="text-lg font-bold text-white group-hover:text-[#00A8FF] transition-colors">
            ...
            <div className="pt-4 border-t border-[#0E2C52] flex items-center justify-between text-xs font-mono text-[#00A8FF]">
