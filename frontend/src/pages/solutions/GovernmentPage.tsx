...
import { ArrowRight, CheckCircle2, AlertTriangle, Layers, MapPin, Activity, Users, BarChart3, Radio } from 'lucide-react';
    ...
    <div className="space-y-16 pb-24">
      ...
      <section className="max-w-7xl mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
          <div className="p-6 rounded-2xl bg-surface border border-rose-900/40 space-y-2">
            ...
            <h3 className="text-base font-bold text-ink">Fragmented Public Charging Data</h3>
          ...
          <div className="p-6 sm:p-7 rounded-2xl bg-surface2 border-2 border-indigo-500/50 space-y-2 shadow-[0_0_25px_rgba(99,102,241,0.12)] md:scale-105">
            ...
            <h3 className="text-base font-bold text-ink">Unified Charging Data</h3>
            <p className="text-xs text-ink2 leading-relaxed">
          ...
          <div className="p-6 rounded-2xl bg-surface border border-emerald-900/50 space-y-2">
            ...
            <h3 className="text-base font-bold text-ink">Evidence-Based Planning</h3>
            <p className="text-xs text-ink2 leading-relaxed">
      ...
      <section className="max-w-7xl mx-auto px-6 space-y-8">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3 text-xs font-mono text-ink3">
          <span className="px-3 py-1.5 rounded-lg bg-surface2 border border-edge">Multiple Operators</span>
          <ArrowRight className="w-3.5 h-3.5 text-indigo-400 rotate-90 sm:rotate-0" />
          <span className="px-3 py-1.5 rounded-lg bg-surface2 border border-edge">Charging Data</span>
          <ArrowRight className="w-3.5 h-3.5 text-indigo-400 rotate-90 sm:rotate-0" />
          ...
          <ArrowRight className="w-3.5 h-3.5 text-indigo-400 rotate-90 sm:rotate-0" />
          <span className="px-3 py-1.5 rounded-lg bg-surface2 border border-edge">Regional View</span>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 items-start">
          <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-4">
            {CAPABILITIES.map((cap) => (
              <div key={cap.title} className="p-4 rounded-xl bg-surface border border-edge space-y-2">
                <div className="w-8 h-8 rounded-lg bg-surface2 border border-edge flex items-center justify-center text-indigo-400">
          ...
          <div className="lg:col-span-3 bg-surface border border-edge rounded-2xl overflow-hidden shadow-[0_0_40px_rgba(99,102,241,0.08)]">
            ...
            <div className="grid grid-cols-3 gap-2 p-4">
              <div className="bg-surface2 border border-edge/70 rounded-xl p-3">
                <div className="text-[9px] font-mono uppercase text-ink4 mb-1">Regions Tracked</div>
                <div className="text-lg font-bold text-ink font-mono">4</div>
              </div>
              <div className="bg-surface2 border border-edge/70 rounded-xl p-3">
                <div className="text-[9px] font-mono uppercase text-ink4 mb-1">Connected Operators</div>
                <div className="text-lg font-bold text-ink font-mono">6</div>
              </div>
              <div className="bg-surface2 border border-edge/70 rounded-xl p-3">
                <div className="text-[9px] font-mono uppercase text-ink4 mb-1">Avg. Coverage</div>
            ...
            <div className="px-4 pb-4 space-y-1.5">
              {REGIONS.map((r) => (
                <div key={r.name} className="flex items-center justify-between px-3 py-2 rounded-lg bg-surface2/60 border border-edge/50">
                  <div className="flex items-center gap-2 text-xs text-ink2">
                    <MapPin className="w-3 h-3 text-ink4" />
                    <span>{r.name}</span>
                  </div>
                  <div className="flex items-center gap-3 text-[10px] font-mono text-ink3">
      ...
      {/* CTA */}
      <section className="max-w-7xl mx-auto px-6">
        <div className="rounded-2xl bg-surface2 border border-indigo-500/40 p-8 text-center space-y-4">
