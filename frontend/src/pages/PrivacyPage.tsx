    ...
    <div className="max-w-4xl mx-auto px-6 py-16 sm:py-24 space-y-8">
      ...
      <div className="prose prose-invert max-w-none text-ink2 text-sm space-y-6 leading-relaxed">
        <section className="space-y-2">
          <h2 className="text-lg font-bold text-ink">1. Overview</h2>
          <p>
        ...
        <section className="space-y-2">
          <h2 className="text-lg font-bold text-ink">2. Data We Process</h2>
          <p>
        ...
        <section className="space-y-2">
          <h2 className="text-lg font-bold text-ink">3. Data Security & Storage</h2>
          <p>
        ...
        <section className="space-y-2">
          <h2 className="text-lg font-bold text-ink">4. Contact Us</h2>
          <p>
