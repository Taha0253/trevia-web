    ...
    <div className="space-y-24 md:space-y-36 pb-24">
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="max-w-3xl space-y-6">
            ...
            <div className="flex flex-wrap items-center gap-4 pt-2">
              ...
              <Link
                to="/technology/apis"
                className="px-8 py-4 rounded-full bg-surface3 border border-edge text-ink2 hover:text-ink font-medium text-sm tracking-wide transition-all"
              >
      ...
      <section className="max-w-7xl mx-auto px-6 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          {/* OCPP 1.6J */}
          <div className="p-6 rounded-2xl bg-surface border border-edge space-y-3">
            <div className="text-[#00A09A] font-mono text-xs font-bold uppercase">Open Standard</div>
            <h4 className="text-lg font-bold text-ink">OCPP 1.6J</h4>
          ...
          <div className="p-6 rounded-2xl bg-surface border border-edge space-y-3">
            ...
            <h4 className="text-lg font-bold text-ink">WebSocket Connectivity</h4>
            <p className="text-xs text-ink2 leading-relaxed">
          ...
          <div className="p-6 rounded-2xl bg-surface border border-edge space-y-3">
            ...
            <h4 className="text-lg font-bold text-ink">Authentication & Heartbeats</h4>
            <p className="text-xs text-ink2 leading-relaxed">
          ...
          <div className="p-6 rounded-2xl bg-surface border border-edge space-y-3">
            ...
            <h4 className="text-lg font-bold text-ink">Commands & Remote Ops</h4>
            <p className="text-xs text-ink2 leading-relaxed">
          ...
          <div className="p-6 rounded-2xl bg-surface border border-edge space-y-3">
            ...
            <h4 className="text-lg font-bold text-ink">Telemetry & Sessions</h4>
            <p className="text-xs text-ink2 leading-relaxed">
          ...
          <div className="p-6 rounded-2xl bg-surface border border-edge space-y-3">
            ...
            <h4 className="text-lg font-bold text-ink">APIs & Integrations</h4>
            <p className="text-xs text-ink2 leading-relaxed">
      ...
      <section className="max-w-7xl mx-auto px-6 space-y-6">
        <div className="max-w-3xl">
          ...
          <p className="text-ink2 text-xs sm:text-sm">
            Standard bidirectional packet flow processed in under 15ms by the Trevia ingestion pipeline.
          </p>
        </div>

        <div className="p-6 rounded-2xl bg-surface border border-edge font-mono text-xs text-ink2 overflow-x-auto">
          <div className="flex items-center justify-between pb-3 border-b border-edge mb-3 text-ink3">
    ...
    "meterValue": [
      ...
      <section className="max-w-4xl mx-auto px-6 space-y-8">
        ...
        <div className="space-y-4">
          <div className="p-6 rounded-2xl bg-surface border border-edge space-y-2">
            ...
            <p className="text-xs sm:text-sm text-ink2 leading-relaxed pl-6">
