          ...
          <div className="p-6 rounded-2xl bg-[#030A14] border border-[#0E2C52] space-y-4">
            <div className="flex flex-wrap items-center justify-between gap-2 pb-3 border-b border-[#0E2C52]">
              <div className="flex items-center gap-3 font-mono text-xs">
                ...
                <span className="text-white font-bold">/v1/chargers/telemetry</span>
              </div>
              <span className="text-slate-400 text-xs font-mono">Live status & power metrics across fleet</span>
            </div>
            <pre className="p-4 bg-[#010408] rounded-xl text-xs font-mono text-slate-300 overflow-x-auto leading-relaxed">
{`{
  "status": "success",
  "data": [
    {
      ...
      <section className="max-w-7xl mx-auto px-6 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-xs font-mono">
          ...
          <div className="p-4 rounded-xl bg-[#030A14] border border-[#0E2C52] space-y-1.5">
            ...
            <div className="text-slate-400">Triggered on unplug with final kWh, duration, and tariff calculation.</div>
          </div>
          <div className="p-4 rounded-xl bg-[#030A14] border border-[#0E2C52] space-y-1.5">
            <div className="text-rose-400 font-bold">charger.fault_detected</div>
            <div className="text-slate-400">Triggered immediately when hardware reports an internal or connector error.</div>
          </div>
          <div className="p-4 rounded-xl bg-[#030A14] border border-[#0E2C52] space-y-1.5">
            <div className="text-amber-400 font-bold">charger.offline</div>
            <div className="text-slate-400">Triggered if consecutive heartbeat pings fail WebSocket timeout thresholds.</div>
          </div>
        </div>
      </section>
