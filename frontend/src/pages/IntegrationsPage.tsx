  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-16 sm:py-24 space-y-8">
      <div className="space-y-3 pb-6 border-b border-[#0E2C52]">
        ...
        <h1 className="text-3xl sm:text-5xl font-bold text-white">Integrations & Ecosystem</h1>
      ...
      <div className="grid sm:grid-cols-2 gap-5">
        {stack.map((item) => {
          ...
          return (
            <div key={item.name} className="p-5 rounded-2xl bg-[#030914] border border-[#0E2644]">
