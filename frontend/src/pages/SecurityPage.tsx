  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-16 sm:py-24 space-y-8">
      <div className="space-y-3 pb-6 border-b border-[#0E2C52]">
        ...
        <h1 className="text-3xl sm:text-5xl font-bold text-white">Security at Trevia</h1>
      ...
      <div className="grid sm:grid-cols-2 gap-5">
        <div className="p-5 rounded-2xl bg-[#030914] border border-[#0E2644]">
          <Lock className="w-5 h-5 text-[#00A09A] mb-3" />
          <h3 className="text-sm font-bold text-white mb-1">Encrypted in Transit</h3>
          <p className="text-xs text-slate-400 leading-relaxed">All charger and dashboard traffic runs over TLS/WSS, including OCPP WebSocket connections.</p>
        </div>
        <div className="p-5 rounded-2xl bg-[#030914] border border-[#0E2644]">
          <Server className="w-5 h-5 text-[#00A09A] mb-3" />
          <h3 className="text-sm font-bold text-white mb-1">Role-Based Access</h3>
          <p className="text-xs text-slate-400 leading-relaxed">Operator accounts are scoped by role, so field staff, dispatch, and admins see only what they need.</p>
        </div>
        <div className="p-5 rounded-2xl bg-[#030914] border border-[#0E2644]">
          <Eye className="w-5 h-5 text-[#00A09A] mb-3" />
          <h3 className="text-sm font-bold text-white mb-1">Session-Level Audit Trail</h3>
          <p className="text-xs text-slate-400 leading-relaxed">Every remote command, tariff change, and charging session is logged against an operator identity.</p>
        </div>
        <div className="p-5 rounded-2xl bg-[#030914] border border-[#0E2644]">
          <ShieldCheck className="w-5 h-5 text-[#00A09A] mb-3" />
          <h3 className="text-sm font-bold text-white mb-1">Isolated Fault Handling</h3>
          <p className="text-xs text-slate-400 leading-relaxed">Charger faults are isolated at the connector level so one failing unit can't take down a station.</p>
        </div>
      </div>

      <div className="p-5 rounded-2xl bg-[#030914] border border-[#0E2644] text-sm text-slate-400 leading-relaxed">
